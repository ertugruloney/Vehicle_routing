        ...
        try:
            ...
            for day in self.Days:
                ...
                for VanRoute in day.VanRoutes:
                    ...
                    #no longer needed: nrOfStops = len(VanRoute.Route)
                    ...
                    for node in VanRoute.Route:
                        if node > 0:
                            ...
                            for a in self.Instance.Requests[node-1].amounts:
                                totalKgInThisVan += a
                    ...
                    self._checkError('The load of van %d exceeds capacity. This happens on day %d' %(VanRoute.ID, day.dayNumber), totalKgInThisVan <= self.Instance.VanCapacity)
